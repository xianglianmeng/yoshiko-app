...
import org.cytoscape.yoshiko.internal.AbstractYoshikoTest;
...
//		assertEquals(score, (double) 1.5, 0);
	...
	public void testCompleteGraphWithDefaultParameters() {
		...
		YoshikoCluster c = clusters.get(0);
	...
	public void testCompleteGraphIncludingLoops() {
		/*CyNetwork net = createCompleteGraph(16);
		int resultId = 1;
		YoshikoParameterSet params = new YoshikoParameterSet();
		params.setIncludeLoops(true);
		
		List<YoshikoCluster> clusters = findClusters(net, resultId, params);
