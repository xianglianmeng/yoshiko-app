...
public class YoshikoCurrentParameters {
	...
	private Map<Long, YoshikoParameterSet> currentParams = new HashMap<Long, YoshikoParameterSet>();
	private Map<Integer, YoshikoParameterSet> resultParams = new HashMap<Integer, YoshikoParameterSet>();
	 ...
	 */
	public YoshikoParameterSet getParamsCopy(Long networkID) {
		if (networkID != null) {
			return currentParams.get(networkID).copy();
		} else {
			YoshikoParameterSet newParams = new YoshikoParameterSet();
	 ...
	 * @param networkID Id of the network
	 */
	public void setParams(YoshikoParameterSet newParams, int resultId, Long networkID) {
	...
	public YoshikoParameterSet getResultParams(int resultId) {
