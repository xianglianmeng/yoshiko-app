 ...
 */
public class YoshikoCollapsiblePanel extends JPanel {
	 ...
	 */
	public YoshikoCollapsiblePanel(JRadioButton component) {
		component.addItemListener(new YoshikoCollapsiblePanel.ExpandAndCollapseAction());
	 ...
	 */
	public YoshikoCollapsiblePanel(String text) {
		arrow.setText(text);
	...
	private ImageIcon[] createExpandAndCollapseIcon() {
		...
		iconURL = YoshikoResources.getUrl(ImageName.ARROW_COLLAPSED);

		if (iconURL != null) {
			iconArrow[COLLAPSED] = new ImageIcon(iconURL);
		}

		iconURL = YoshikoResources.getUrl(ImageName.ARROW_EXPANDED);
	...
	private JButton createArrowButton() {
		...
		button.addActionListener(new YoshikoCollapsiblePanel.ExpandAndCollapseAction());
