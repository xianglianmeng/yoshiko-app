 ...
 */
public class YoshikoAboutDialog extends JDialog {
	...
	public YoshikoAboutDialog(final CySwingApplication swingApplication,
							final OpenBrowser openBrowser,
							final YoshikoUtil mcodeUtil) {
		super(swingApplication.getJFrame(), "About Yoshiko", false);
	...
	private JEditorPane getMainContainer() {
		if (mainContainer == null) {
			...
			URL logoURL = YoshikoResources.getUrl(ImageName.LOGO);
			String logoCode = "";
